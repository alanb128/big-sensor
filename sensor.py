...
sensor_dict = {
    ...
    20: {'name': 'TSL2591 High Dynamic Range Digital Light Sensor', 'short': 'TSL2591', 'func': sensor_tsl2591, 'class_ref': adafruit_tsl2591.TSL2591, 'i2c_addr': 0x29, 'chip_id': 0x12, 'chip_value': 0x05},
    21: {'name': 'AS7341 10-Channel Light / Color Sensor', 'short': 'AS7341', 'func': sensor_as7341, 'class_ref': adafruit_as7341.AS7341, 'i2c_addr': 0x39, 'chip_id': 0x92, 'chip_value': 0x09},
    22: {'name': 'VCNL4040 Proximity Sensor', 'short': 'VCNL4040', 'func': sensor_vcnl4040, 'class_ref': adafruit_vcnl4040.VCNL4040, 'i2c_addr': 0x60, 'chip_id': 0x0c, 'chip_value': 0x86},
    ...
    24: {'name': 'ADXL343 Digital MEMS Accelerometer', 'short': 'ADXL343', 'func': sensor_adxl343, 'class_ref': adafruit_adxl34x.ADXL343, 'i2c_addr': 0x53, 'chip_id': 0x00, 'chip_value': 0xE5}
